...
function loadWidget(config) {
	...
	document.body.insertAdjacentHTML("beforeend", `<div id="waifu">
			...
			<canvas id="live2d" width="800" height="955"></canvas>
			<div id="waifu-tool">
	...
	(function welcomeMessage() {
		...
		if (location.pathname === "/") { // 如果是主页
			...
			setTimeout(() => showMessage(text, 8000, 8), 3500);
	} else if (document.referrer !== "") {
			const referrer = new URL(document.referrer),
				domain = referrer.hostname.split(".")[1];
			if (location.hostname === referrer.hostname) text = {i18n: "welcome.1", data: document.title};
			...
			setTimeout(() => showMessage(text, 4000, 8), 3500);
			...
			setTimeout(() => showMessage(text, 600000, 10), 3500);
		}
		else {
			text = {i18n: "welcome.1", data: document.title};
			setTimeout(() => showMessage(text, 4000, 8), 3500);
		}
		//setInterval(welcomeMessage, 1500);
	})();
